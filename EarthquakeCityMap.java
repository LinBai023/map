...
public class EarthquakeCityMap extends PApplet {
	...
	private void displayCitiesWithinThrearCircle(double dangerRadius, Location quakeLocation){
	...
	private void displayThreat(float x, float y){
		...
		if(!cityMarkerSelected){
			...
			if(!quakeMarkerSelected){
				...
				displayCitiesWithinThrearCircle(kmCircle,lastClicked.getLocation());
	...
	public static void main(String args[]){
		EarthquakeCityMap mp= new EarthquakeCityMap();
		PApplet.runSketch(new String[]{"EarthquakeCityMap"},mp);
	}
